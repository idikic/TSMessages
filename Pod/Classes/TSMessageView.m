...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = [UIColor hex_colorWithHexString:current[@"backgroundColor"]];
            [self addSubview:self.backgroundBlurView];
        }

        UIColor *fontColor = [UIColor hex_colorWithHexString:[current valueForKey:@"textColor"]];
        ...
        [self.titleLabel setShadowColor:[UIColor hex_colorWithHexString:[current valueForKey:@"shadowColor"]]];
        ...
        if ([subtitle length])
        {
            ...
            UIColor *contentTextColor = [UIColor hex_colorWithHexString:[current valueForKey:@"contentTextColor"]];
            if (!contentTextColor)
            {
        ...
        if ([buttonTitle length])
        {
            ...
            UIColor *buttonTitleShadowColor = [UIColor hex_colorWithHexString:[current valueForKey:@"buttonTitleShadowColor"]];
            ...
            UIColor *buttonTitleTextColor = [UIColor hex_colorWithHexString:[current valueForKey:@"buttonTitleTextColor"]];
        ...
        if (![TSMessage iOS7StyleEnabled])
        {
            ...
            self.borderView.backgroundColor = [UIColor hex_colorWithHexString:[current valueForKey:@"borderColor"]];
